<?php
if (isset($_GET['order']) && ($_GET['order'] === 'Commander')) {
    ...
    $product->addProduct('', $_SESSION['creation']['bra'], '', $_SESSION['creation']['material'], $getStylist['id']);
...
?>
        ...
        <div class="stylist">
            <div class="txtStylist">
                ...
                <p class="areaTxt">Nous mettons à votre disposition une équipe de stylistes ayant chacun sa propre touche. Découvrez leur personnalité au travers de leurs créations</p>
                <a href="?page=inscription"><input type="button" class="buttonBegin" value="Voir plus"></a>           
            </div>
        ...
        <div class="begin">
            <div class="contentBegin">
                ...
                <a href="?page=inscription"><input type="button" class="buttonBegin" value="A toi de jouer !"></a>
            </div>
        </div>